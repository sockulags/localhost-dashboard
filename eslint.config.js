...
const componentGlobals = {
  ...
  // renderer/js/components/timeline-view.js
  timelineEvents: 'writable',
  timelineFilter: 'writable',
  TIMELINE_FILTERS: 'writable',
  TIMELINE_TYPE_META: 'writable',
  timelineRelTime: 'writable',
  timelineKeyHandler: 'writable',
  showTimeline: 'writable',
  closeTimeline: 'writable',
  refreshTimeline: 'writable',
  renderTimelineModal: 'writable',
  buildTimelineItem: 'writable',
  renderTimelineBody: 'writable',
